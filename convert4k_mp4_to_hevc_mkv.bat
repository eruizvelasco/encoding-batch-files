@ECHO OFF
REM ** convert4k_mp4_to_hevc_mkv batch file **
REM
...
REM then encodes to HEVC using ffmpeg with CUDA acceleration and moves the 4K file moves to <drive>:\4K directory.
